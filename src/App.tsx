...
function App() {
  return (
    <div className="mt-8 flex flex-col gap-3">
      ...
      >
        <p>
        Then go to your Vite based project and run npm link --global vite (or the package manager that that you used to link {""} <a href="/">vite globally</a>). Now restart the development server to ride on the bleeding edge!
        </p>
      </Alert>
      ...
      <Alert
        ...
        description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos voluptatum illo reiciendis facere vitae esse, ullam molestias ipsa nesciunt? Minima."
      />
      <Alert
        type={"alert-tips"}
